...
function ViewGalleryPro(){
	...
	$('<br><br><div class="row"> <div class="col-lg-12"> <h1 class="page-header">Galeria <small>Inmuebles</small> </h1> </div></div><hr>').appendTo('#contenido');
